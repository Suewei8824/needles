...
$("._submit").click(function () {
    ...
    if((realname === olduser.realname && username === olduser.username) || (!realname && !username)) {
        showTips("您未修改任何信息！");
    } 
    else {
        var submit = $("._submit").removeClass("opacity");
        var newuser = {
...
$(".submit_").click(function () {
    ...
    if(!oldpass) {
        ...
        postPass(oldpass, newpass, confirm);
    }
})

function postPass(oldpass, newpass, confirm) {
    $.ajax({
        url: host + "/user/password",
        type: "PUT",
        data: JSON.stringify({
            "old": oldpass.MD5(32).MD5(32).MD5(32),
            "new": newpass.MD5(32).MD5(32).MD5(32),
            "confirm": confirm.MD5(32).MD5(32).MD5(32)
        }),
        contentType: "application/json",
        dataType: "json",
        success: function(res) {
