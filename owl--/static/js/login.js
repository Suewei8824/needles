...
//var host = "https://alpha-owl.aidigger.com/api/v1";
var host = "/api/v1";
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.hasOwnProperty("status") && res.status === "success") {
                localStorage.setItem("userinfo", JSON.stringify({ realname: res.realname, username: res.username }));
                !!res.next ?
                    window.location.href = res.next
                    :
                    window.location.href = "https://labs.aidigger.com"
